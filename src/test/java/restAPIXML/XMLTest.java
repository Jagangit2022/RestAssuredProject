...
public class XMLTest {
	...
	public void test2() {
		...
		System.out.println("Language of the first book is : " +books.get(0).getAttribute("lang"));
		
		for(String name: books) {
			System.out.println("Book name : " +name.toString());
		}
	...
	/*	for(int index=0;index<books.size();index++) {
		...
		System.out.println("Second Price is: " +prices.get(1).toString());
		System.out.println("Children size is: " +prices.get(0).children().size());
